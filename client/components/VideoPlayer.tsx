...
const VideoPlayer = () => {
  ...
  return (
    <div className=" flex w-full items-center justify-center px-4 py-8">
      <div className="relative flex aspect-auto items-center justify-center overflow-hidden rounded-md">
        <video
          ref={myVideo}
          muted
          autoPlay
        ...
        {callAccepted && !callEnded && (
          <div className="absolute right-2 top-4 w-[100px] aspect-auto bg-gray-500">
            <video
              ref={userVideo}
              autoPlay
              playsInline
